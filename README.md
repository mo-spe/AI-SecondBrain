...
(https://mcndr2y6zasu.feishu.cn/wiki/BcFcwuFIFi35ZxkAsmUcLukvnXe?table=tblsuZt7f1YqkV9w&view=vewLgt4u2h)
...
│                    应用层                                │
│  ┌─────────────────────┐  ┌─────────────────────┐      │
│  │  Spring Boot 后端   │  │   rag服务（Python）待定|      |
│  │   (Java 17)         │  │                     │
│  └─────────────────────┘  └─────────────────────┘      │
└─────────────────────────────────────────────────────────┘
                          │
...
### AI API 配置（这个可以舍弃了，我们改为用户可以在前端自行管理和配置）
