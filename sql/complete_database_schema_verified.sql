-- ============================================================
-- AI-SecondBrain 数据库完整建表语句（基于实际数据库验证）
-- ============================================================
-- 说明：
-- 1. 这是项目的完整数据库结构（包含所有 12 张表）
-- 2. 包含所有表、索引、注释
-- 3. 适用于 MySQL 8.0+
...
-- - idx_from_knowledge_id：源知识节点 ID 索引
-- - idx_to_knowledge_id：目标知识节点 ID 索引
