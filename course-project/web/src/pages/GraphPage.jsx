...
export default function GraphPage() {
  ...
  return (
    <div className="page-wrap graph-page">
      ...
      {loading ? <PageLoading label="正在整理知识关系…" /> : graph.nodes.length === 0 ? <div className="list-empty"><BookOpen size={22} /><h2>图谱还没有节点</h2><p>先创建两个带有相同标签的知识点。</p></div> : <div className="graph-layout">
